...
def me_parse():
    ...
    modules_subparser_collections = modules_subparser.add_parser('collections', help="Modules collections Sub Command")
    ...
    modules_subparser_statistics = modules_subparser.add_parser('statistics', help="Modules statistics Sub Command")
 
    # itertools  module sub-command
    modules_subparser_itertools = modules_subparser.add_parser('itertools', help="Modules itertools Sub Command")
 
    # functools  module sub-command
    modules_subparser_functools = modules_subparser.add_parser('functools', help="Modules functools Sub Command")
    ...
    modules_subparser_configparser = modules_subparser.add_parser('configparser', help="Modules configparser Sub Command")
    ...
    modules_subparser_threading = modules_subparser.add_parser('threading', help="Modules threading Sub Command")
 
    # multiprocessing  module sub-command
    modules_subparser_multiprocessing = modules_subparser.add_parser('multiprocessing', help="Modules multiprocessing Sub Command")
 
    # concurrent module sub-command
    modules_subparser_concurrent = modules_subparser.add_parser('concurrent', help="Modules concurrent Sub Command")
 
    # subprocess  module sub-command
    modules_subparser_subprocess = modules_subparser.add_parser('subprocess', help="Modules subprocess Sub Command")
    ...
    modules_subparser__thread = modules_subparser.add_parser('_thread', help="Modules _thread Sub Command")
    ...
    modules_subparser_socketserver = modules_subparser.add_parser('socketserver', help="Modules socketserver Sub Command")
 
    #  ipaddress module sub-command
    modules_subparser_ipaddress = modules_subparser.add_parser('ipaddress', help="Modules ipaddress Sub Command")
    ...
    modules_subparser_sysconfig = modules_subparser.add_parser('sysconfig', help="Modules sysconfig Sub Command")
    ...
    modules_subparser_importlib = modules_subparser.add_parser('importlib', help="Modules importlib Sub Command")
    ...
    if hasattr(args, 'sub_parser_name'):
        if args.sub_parser_name == 'play':
            ...
            if not args.modules_parser:
                ...
                modules_parser.set_defaults(func=me_modules.me_modules, cmd='modules')
                ...
                import libs.me_modules as me_modules
                modules_subparser_requests.set_defaults(func=me_modules.me_modules_requests, cmd='modules.requests')
            elif args.modules_parser == 'datetime':
                import libs.me_modules as me_modules
                modules_subparser_datetime.set_defaults(func=me_modules.me_modules_datetime, cmd='modules.datetime')
            elif args.modules_parser == 'collections':
                import libs.me_modules as me_modules
                modules_subparser_collections.set_defaults(func=me_modules.me_modules_collections, cmd='modules.collections')
            elif args.modules_parser == 'heapq':
                import libs.me_modules as me_modules
                modules_subparser_heapq.set_defaults(func=me_modules.me_modules_heapq, cmd='modules.heapq')
            elif args.modules_parser == 'bisect':
                import libs.me_modules as me_modules
                modules_subparser_bisect.set_defaults(func=me_modules.me_modules_bisect, cmd='modules.bisect')
            elif args.modules_parser == 'types':
                import libs.me_modules as me_modules
                modules_subparser_types.set_defaults(func=me_modules.me_modules_types, cmd='modules.types')
            elif args.modules_parser == 'array':
                import libs.me_modules as me_modules
                modules_subparser_array.set_defaults(func=me_modules.me_modules_array, cmd='modules.array')
            elif args.modules_parser == 'copy':
                import libs.me_modules as me_modules
                modules_subparser_copy.set_defaults(func=me_modules.me_modules_copy, cmd='modules.copy')
            elif args.modules_parser == 'pprint':
                import libs.me_modules as me_modules
                modules_subparser_pprint.set_defaults(func=me_modules.me_modules_pprint, cmd='modules.pprint')
            elif args.modules_parser == 'math':
                import libs.me_modules as me_modules
                modules_subparser_math.set_defaults(func=me_modules.me_modules_math, cmd='modules.math')
            elif args.modules_parser == 'random':
                import libs.me_modules as me_modules
                modules_subparser_random.set_defaults(func=me_modules.me_modules_random, cmd='modules.random')
            elif args.modules_parser == 'statistics':
                import libs.me_modules as me_modules
                modules_subparser_statistics.set_defaults(func=me_modules.me_modules_statistics, cmd='modules.statistics')
            elif args.modules_parser == 'itertools':
                import libs.me_modules as me_modules
                modules_subparser_itertools.set_defaults(func=me_modules.me_modules_itertools, cmd='modules.itertools')
            elif args.modules_parser == 'functools':
                import libs.me_modules as me_modules
                modules_subparser_functools.set_defaults(func=me_modules.me_modules_functools, cmd='modules.functools')
            elif args.modules_parser == 'operator':
                import libs.me_modules as me_modules
                modules_subparser_operator.set_defaults(func=me_modules.me_modules_operator, cmd='modules.operator')
            elif args.modules_parser == 'pathlib':
                import libs.me_modules as me_modules
                modules_subparser_pathlib.set_defaults(func=me_modules.me_modules_pathlib, cmd='modules.pathlib')
            elif args.modules_parser == 'os':
                import libs.me_modules as me_modules
                modules_subparser_os.set_defaults(func=me_modules.me_modules_os, cmd='modules.os')
            elif args.modules_parser == 'glob':
                import libs.me_modules as me_modules
                modules_subparser_glob.set_defaults(func=me_modules.me_modules_glob, cmd='modules.glob')
            elif args.modules_parser == 'fnmatch':
                import libs.me_modules as me_modules
                modules_subparser_fnmatch.set_defaults(func=me_modules.me_modules_fnmatch, cmd='modules.fnmatch')
            elif args.modules_parser == 'shutil':
                import libs.me_modules as me_modules
                modules_subparser_shutil.set_defaults(func=me_modules.me_modules_shutil, cmd='modules.shutil')
            elif args.modules_parser == 'sqlite3':
                import libs.me_modules as me_modules
                modules_subparser_sqlite3.set_defaults(func=me_modules.me_modules_sqlite3, cmd='modules.sqlite3')
            elif args.modules_parser == 'csv':
                import libs.me_modules as me_modules
                modules_subparser_csv.set_defaults(func=me_modules.me_modules_csv, cmd='modules.csv')
            elif args.modules_parser == 'json':
                import libs.me_modules as me_modules
                modules_subparser_json.set_defaults(func=me_modules.me_modules_json, cmd='modules.json')
            elif args.modules_parser == 'configparser':
                import libs.me_modules as me_modules
                modules_subparser_configparser.set_defaults(func=me_modules.me_modules_configparser, cmd='modules.configparser')
            elif args.modules_parser == 'io':
                import libs.me_modules as me_modules
                modules_subparser_io.set_defaults(func=me_modules.me_modules_io, cmd='modules.io')
            elif args.modules_parser == 'time':
                import libs.me_modules as me_modules
                modules_subparser_time.set_defaults(func=me_modules.me_modules_time, cmd='modules.time')
            elif args.modules_parser == 'errno':
                import libs.me_modules as me_modules
                modules_subparser_errno.set_defaults(func=me_modules.me_modules_errno, cmd='modules.errno')
            elif args.modules_parser == 'curses':
                import libs.me_modules as me_modules
                modules_subparser_curses.set_defaults(func=me_modules.me_modules_curses, cmd='modules.curses')
            elif args.modules_parser == 'ctypes':
                import libs.me_modules as me_modules
                modules_subparser_ctypes.set_defaults(func=me_modules.me_modules_ctypes, cmd='modules.ctypes')
            elif args.modules_parser == 'threading':
                import libs.me_modules as me_modules
                modules_subparser_threading.set_defaults(func=me_modules.me_modules_threading, cmd='modules.threading')
            elif args.modules_parser == 'multiprocessing':
                import libs.me_modules as me_modules
                modules_subparser_multiprocessing.set_defaults(func=me_modules.me_modules_multiprocessing, cmd='modules.multiprocessing')
            elif args.modules_parser == 'concurrent':
                import libs.me_modules as me_modules
                modules_subparser_concurrent.set_defaults(func=me_modules.me_modules_concurrent, cmd='modules.concurrent')
            elif args.modules_parser == 'subprocess':
                import libs.me_modules as me_modules
                modules_subparser_subprocess.set_defaults(func=me_modules.me_modules_subprocess, cmd='modules.subprocess')
            elif args.modules_parser == 'sched':
                import libs.me_modules as me_modules
                modules_subparser_sched.set_defaults(func=me_modules.me_modules_sched, cmd='modules.sched')
            elif args.modules_parser == 'queue':
                import libs.me_modules as me_modules
                modules_subparser_queue.set_defaults(func=me_modules.me_modules_queue, cmd='modules.queue')
            elif args.modules_parser == '_thread':
                import libs.me_modules as me_modules
                modules_subparser__thread.set_defaults(func=me_modules.me_modules__thread, cmd='modules._thread')
            elif args.modules_parser == 'asyncio':
                import libs.me_modules as me_modules
                modules_subparser_asyncio.set_defaults(func=me_modules.me_modules_asyncio, cmd='modules.asyncio')
            elif args.modules_parser == 'socket':
                import libs.me_modules as me_modules
                modules_subparser_socket.set_defaults(func=me_modules.me_modules_socket, cmd='modules.socket')
            elif args.modules_parser == 'ssl':
                import libs.me_modules as me_modules
                modules_subparser_ssl.set_defaults(func=me_modules.me_modules_ssl, cmd='modules.ssl')
            elif args.modules_parser == 'mmap':
                import libs.me_modules as me_modules
                modules_subparser_mmap.set_defaults(func=me_modules.me_modules_mmap, cmd='modules.mmap')
            elif args.modules_parser == 'signal':
                import libs.me_modules as me_modules
                modules_subparser_signal.set_defaults(func=me_modules.me_modules_signal, cmd='modules.signal')
            elif args.modules_parser == 'urllib':
                import libs.me_modules as me_modules
                modules_subparser_urllib.set_defaults(func=me_modules.me_modules_urllib, cmd='modules.urllib')
            elif args.modules_parser == 'http':
                import libs.me_modules as me_modules
                modules_subparser_http.set_defaults(func=me_modules.me_modules_http, cmd='modules.http')
            elif args.modules_parser == 'socketserver':
                import libs.me_modules as me_modules
                modules_subparser_socketserver.set_defaults(func=me_modules.me_modules_socketserver, cmd='modules.socketserver')
            elif args.modules_parser == 'ipaddress':
                import libs.me_modules as me_modules
                modules_subparser_ipaddress.set_defaults(func=me_modules.me_modules_ipaddress, cmd='modules.ipaddress')
            elif args.modules_parser == 'turtle':
                import libs.me_modules as me_modules
                modules_subparser_turtle.set_defaults(func=me_modules.me_modules_turtle, cmd='modules.turtle')
            elif args.modules_parser == 'cmd':
                import libs.me_modules as me_modules
                modules_subparser_cmd.set_defaults(func=me_modules.me_modules_cmd, cmd='modules.cmd')
            elif args.modules_parser == 'shlex':
                import libs.me_modules as me_modules
                modules_subparser_shlex.set_defaults(func=me_modules.me_modules_shlex, cmd='modules.shlex')
            elif args.modules_parser == 'tkinter':
                import libs.me_modules as me_modules
                modules_subparser_tkinter.set_defaults(func=me_modules.me_modules_tkinter, cmd='modules.tkinter')
            elif args.modules_parser == 'typing':
                import libs.me_modules as me_modules
                modules_subparser_typing.set_defaults(func=me_modules.me_modules_typing, cmd='modules.typing')
            elif args.modules_parser == 'pydoc':
                import libs.me_modules as me_modules
                modules_subparser_pydoc.set_defaults(func=me_modules.me_modules_pydoc, cmd='modules.pydoc')
            elif args.modules_parser == 'pdb':
                import libs.me_modules as me_modules
                modules_subparser_pdb.set_defaults(func=me_modules.me_modules_pdb, cmd='modules.pdb')
            elif args.modules_parser == 'timeit':
                import libs.me_modules as me_modules
                modules_subparser_timeit.set_defaults(func=me_modules.me_modules_timeit, cmd='modules.timeit')
            elif args.modules_parser == 'sys':
                import libs.me_modules as me_modules
                modules_subparser_sys.set_defaults(func=me_modules.me_modules_sys, cmd='modules.sys')
            elif args.modules_parser == 'sysconfig':
                import libs.me_modules as me_modules
                modules_subparser_sysconfig.set_defaults(func=me_modules.me_modules_sysconfig, cmd='modules.sysconfig')
            elif args.modules_parser == 'inspect':
                import libs.modules.me_modules_inspect
                modules_subparser_inspect.set_defaults(func=libs.modules.me_modules_inspect.me_modules_inspect, cmd='modules.inspect')
            elif args.modules_parser == 'importlib':
                import libs.me_modules as me_modules
                modules_subparser_importlib.set_defaults(func=me_modules.me_modules_importlib, cmd='modules.importlib')
