...
def me_parse():  # noqa: WPS210 WPS213 WPS231 C901 CCR001 CFQ001
    ...
    parser.add_argument(
        "--practice", "-p", help="practice runs", action="store_true"
    ...
    modules_subparser_requests = modules_subparser.add_parser(
        "requests", help="Modules Requests Sub Command"
    )

    #  datetime module sub-command
    modules_subparser_datetime = modules_subparser.add_parser(
    ...
    modules_subparser_collections = modules_subparser.add_parser(
        "collections", help="Modules collections Sub Command"
    )
    ...
    modules_subparser_fnmatch = modules_subparser.add_parser(
    ...
    modules_subparser_sqlite3 = modules_subparser.add_parser(
    ...
    modules_subparser_configparser = modules_subparser.add_parser(
        "configparser", help="Modules configparser Sub Command"
    )
    ...
    modules_subparser_asyncio = modules_subparser.add_parser(
    ...
    modules_subparser_socketserver = modules_subparser.add_parser(
        "socketserver", help="Modules socketserver Sub Command"
    )

    #  ipaddress module sub-command
    modules_subparser_ipaddress = modules_subparser.add_parser(
        "ipaddress", help="Modules ipaddress Sub Command"
    )
    ...
    modules_subparser_tkinter = modules_subparser.add_parser(
    ...
    modules_subparser_sysconfig = modules_subparser.add_parser(
        "sysconfig", help="Modules sysconfig Sub Command"
    )

    # inspect  module sub-command
    modules_subparser_inspect = modules_subparser.add_parser(
    ...
    modules_subparser_importlib = modules_subparser.add_parser(
        "importlib", help="Modules importlib Sub Command"
    )
        ...
        if args.sub_parser_name == "play":
            if not args.play_parser:
                ...
                play_subparser_practice.set_defaults(
                    func=scratchpad.practice.practice_demo, cmd="practice"
                )
            ...
            multiprocessing_parser.set_defaults(
                func=libs.me_multiprocessing.me_multiprocessing, cmd="multiprocessing"
            )
            ...
            if not args.modules_parser:
                ...
                modules_subparser_astral.set_defaults(
                    func=libs.modules.me_modules_astral.me_modules_astral, cmd="modules.astral"
                )
            elif args.modules_parser == "opencv":
                import libs.modules.me_modules_opencv

                modules_subparser_opencv.set_defaults(
                    func=libs.modules.me_modules_opencv.me_modules_opencv, cmd="modules.opencv"
                )
            elif args.modules_parser == "sys":
                import libs.modules.me_modules_sys

                modules_subparser_sys.set_defaults(
                    func=libs.modules.me_modules_sys.me_modules_sys, cmd="modules.sys"
                )
                ...
                modules_subparser_pprint.set_defaults(
                    func=me_modules.me_modules_pprint, cmd="modules.pprint"
                )
                ...
                modules_subparser_fnmatch.set_defaults(
                    func=me_modules.me_modules_fnmatch, cmd="modules.fnmatch"
                )
            elif args.modules_parser == "shutil":
                import libs.me_modules as me_modules

                modules_subparser_shutil.set_defaults(
                    func=me_modules.me_modules_shutil, cmd="modules.shutil"
                )
            elif args.modules_parser == "sqlite3":
                import libs.me_modules as me_modules

                modules_subparser_sqlite3.set_defaults(
                    func=me_modules.me_modules_sqlite3, cmd="modules.sqlite3"
                )
                ...
                modules_subparser_configparser.set_defaults(
                    func=me_modules.me_modules_configparser, cmd="modules.configparser"
                )
                ...
                modules_subparser_signal.set_defaults(
                    func=me_modules.me_modules_signal, cmd="modules.signal"
                )
            elif args.modules_parser == "urllib":
                import libs.me_modules as me_modules

                modules_subparser_urllib.set_defaults(
                    func=me_modules.me_modules_urllib, cmd="modules.urllib"
                )
                ...
                modules_subparser_socketserver.set_defaults(
                    func=me_modules.me_modules_socketserver, cmd="modules.socketserver"
                )
            elif args.modules_parser == "ipaddress":
                import libs.me_modules as me_modules

                modules_subparser_ipaddress.set_defaults(
                    func=me_modules.me_modules_ipaddress, cmd="modules.ipaddress"
                )
            elif args.modules_parser == "turtle":
                import libs.me_modules as me_modules

                modules_subparser_turtle.set_defaults(
                    func=me_modules.me_modules_turtle, cmd="modules.turtle"
                )
                ...
                modules_subparser_shlex.set_defaults(
                    func=me_modules.me_modules_shlex, cmd="modules.shlex"
                )
            elif args.modules_parser == "tkinter":
                import libs.me_modules as me_modules

                modules_subparser_tkinter.set_defaults(
                    func=me_modules.me_modules_tkinter, cmd="modules.tkinter"
                )
            elif args.modules_parser == "typing":
                import libs.me_modules as me_modules

                modules_subparser_typing.set_defaults(
                    func=me_modules.me_modules_typing, cmd="modules.typing"
                )
            elif args.modules_parser == "pydoc":
                import libs.me_modules as me_modules

                modules_subparser_pydoc.set_defaults(
                    func=me_modules.me_modules_pydoc, cmd="modules.pydoc"
                )
                ...
                modules_subparser_timeit.set_defaults(
                    func=me_modules.me_modules_timeit, cmd="modules.timeit"
                )
                ...
                modules_subparser_sysconfig.set_defaults(
                    func=me_modules.me_modules_sysconfig, cmd="modules.sysconfig"
                )
            elif args.modules_parser == "inspect":
                import libs.modules.me_modules_inspect

                modules_subparser_inspect.set_defaults(
                    func=libs.modules.me_modules_inspect.me_modules_inspect, cmd="modules.inspect"
                )
            elif args.modules_parser == "importlib":
                import libs.me_modules as me_modules

                modules_subparser_importlib.set_defaults(
                    func=me_modules.me_modules_importlib, cmd="modules.importlib"
                )
